...
public class SkillCommand implements CommandExecutor {
    ...
    private boolean sendStats(UUID uuid) {
        ...
        p.sendMessage(ChatColor.GOLD + "[" + ChatColor.LIGHT_PURPLE + "Magic" + ChatColor.GOLD + "]" + "          " + ChatColor.GOLD + "[" + ChatColor.YELLOW + mp.getLevel(Skill.MAGIC) + ChatColor.GOLD + "]" + "   " + ChatColor.GRAY + fitString(mp.getLevel(Skill.MAGIC)) + ChatColor.GOLD + "[" + ChatColor.GREEN + mp.getExp(Skill.MAGIC) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + ExpTable.valueOf("L" + Integer.toString(mp.getLevel(Skill.MAGIC) + 1)).getExp() + ChatColor.GOLD + "]");
