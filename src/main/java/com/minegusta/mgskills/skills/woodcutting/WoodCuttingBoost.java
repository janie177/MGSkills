...
public class WoodCuttingBoost
{
    ...
    public WoodCuttingBoost(BlockBreakEvent e)
    {
        ...
        //Checking all the methods and then applying
    ...
    private void runNest()
    {
        ...
        if(type.equals(Material.LOG) || type.equals(Material.AIR) || type.equals(Material.LOG_2) || type.equals(Material.LEAVES) || type.equals(Material.LEAVES_2) || type.equals(Material.DIRT) || type.equals(Material.GRASS))b.getRelative(BlockFace.DOWN).setType(Material.HAY_BLOCK);
        sendMessage();
        spawnChickens();
        giveItems();
        eggs();
