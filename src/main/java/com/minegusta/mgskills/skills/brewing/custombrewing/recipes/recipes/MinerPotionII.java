...
public class MinerPotionII implements PotionRecipe
{
    /**
     * The name of this potion in color!
     */
    private static String name = ChatColor.YELLOW + "Miner Potion II";
     ...
     */
    private static String ingredient1 = "1 Diamond Pickaxe";
    private static String ingredient2 = "5 Coal";
    private static String ingredient3 = "5 Red Stone";

    public static int[][] ingredients = {{257, 1, 0}, {263, 5, 0}, {331,5,0}};
    ...
    private static int effect1Duration = 300;
