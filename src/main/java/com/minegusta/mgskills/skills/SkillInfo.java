...
public enum SkillInfo {
    ...
    BREWING(new String[]{
            ...
            ChatColor.GRAY + "Use the .",
            ChatColor.GOLD + "Bonuses Per Level:",
            " - " + ChatColor.GREEN + "23: " + ChatColor.GRAY + "...",
            " - " + ChatColor.GREEN + "36: " + ChatColor.GRAY + "...",
            " - " + ChatColor.GREEN + "52: " + ChatColor.GRAY + "...",
            " - " + ChatColor.GREEN + "69: " + ChatColor.GRAY + "You can now stack potions.",
            " - " + ChatColor.GREEN + "84: " + ChatColor.GRAY + "When brewing potions, get 50% chance to brew twice as many potions.",
            " - " + ChatColor.GREEN + "94: " + ChatColor.GRAY + "",
